...
******************************************************************************
*   DESCRIPTION : TIMER_GDC_PWM low level driver header file
******************************************************************************
...
*****************************************************************************/
#ifndef TIMER_GDC_PWM_H
#define TIMER_GDC_PWM_H
...
*                 Constants                   *
**********************************************/
#define LLDD_TIMER_GDC_PWM_H_REVISION     "$Revision: 1.10 $"
#define LLDD_TIMER_GDC_PWM_H_TAG          "$Name: LLDD_1_6 $"
...
typedef enum tag_timer_gdc_pwm_cntrl_e
{
  TIMER_GDC_PWM_CNTRL_0 = 0,
  TIMER_GDC_PWM_CNTRL_1 = 0x1000 
} timer_gdc_pwm_cntrl_e;
...
typedef enum tag_timer_gdc_pwm_en_e
{
    TIMER_GDC_PWM_DISABLE = 0x0,                /* Double buffer disabled */
    TIMER_GDC_PWM_ENABLE  = 0x1                 /* Double buffering enabled */
} timer_gdc_pwm_en_e;

/* PWMCR.SCLK / HSPWMCR.SCLK / GPWMCR.SCLK - prescaler selection */
typedef enum tag_timer_gdc_pwm_sclk_e
{
    TIMER_GDC_PWM_SCLK_DIV1   = 0x0,            /* IM-Bus frequency [40 MHz] / G-Bus frequency [140 MHz] / Dot Clock */
    TIMER_GDC_PWM_SCLK_DIV2   = 0x1,            /* IM-Bus/G-Bus/Dot-Clock frequency / 2 */
    TIMER_GDC_PWM_SCLK_DIV4   = 0x2,            /* IM-Bus/G-Bus/Dot-Clock frequency / 4 */
    TIMER_GDC_PWM_SCLK_DIV8   = 0x3,            /* IM-Bus/G-Bus/Dot-Clock frequency / 8 */
    TIMER_GDC_PWM_SCLK_DIV16  = 0x4,            /* IM-Bus/G-Bus/Dot-Clock frequency / 16 */
    TIMER_GDC_PWM_SCLK_DIV32  = 0x5,            /* IM-Bus/G-Bus/Dot-Clock frequency / 32 */
    TIMER_GDC_PWM_SCLK_DIV64  = 0x6,            /* IM-Bus/G-Bus/Dot-Clock frequency / 64 */
    TIMER_GDC_PWM_SCLK_DIV128 = 0x7             /* IM-Bus/G-Bus/Dot-Clock frequency / 128 */
} timer_gdc_pwm_sclk_e;

/* PWMCR.RC / GPWMCR.RC - reset of the counter */
typedef enum tag_timer_gdc_pwm_rc_e
{
    TIMER_GDC_PWM_PDR_ONLY   = 0x0,             /* Reset on PWMPDR match only */
    TIMER_GDC_PWM_PDR_HSYNC  = 0x1,             /* Reset on HSync edge and on PWMPDR match */
    TIMER_GDC_PWM_PDR_VSYNC  = 0x2,             /* Reset on VSync edge and on PWMPDR match */
    TIMER_GDC_PWM_PDR_HVSYNC = 0x3              /* Reset on HSync, Vsync and on PWMPDR match */
} timer_gdc_pwm_rc_e;

/* PWMCR.VED / PWMCR.HED / GPWMCR.VED / GPWMCR.HED  - sync edge detection */
typedef enum tag_timer_gdc_pwm_ved_e
{
    TIMER_GDC_PWM_SYNC_POS = 0x0,               /* Positive V/HSync edge detected */
    TIMER_GDC_PWM_SYNC_NEG = 0x1                /* Negative V/HSync edge detected */
} timer_gdc_pwm_ved_e;

/* PWMCR.OL / HSPWMCR.OL / GPWMCR.OL - output level */
typedef enum tag_timer_gdc_pwm_ol_e
{
    TIMER_GDC_PWM_LEVEL_LO = 0x0,               /* PWM starts active low (low duty cycle) */
    TIMER_GDC_PWM_LEVEL_HI = 0x1                /* PWM starts active high (high duty cycle) */
} timer_gdc_pwm_ol_e;

/* PWMCR.GDC / GPWMCR.GDC - display synchronization signals */
typedef enum tag_timer_gdc_pwm_gdc_e
{
    TIMER_GDC_PWM_HSYNC   = 0x0,                /* HSync selected */
    TIMER_GDC_PWM_DOTCLK  = 0x1,                /* DotClock selected */
    TIMER_GDC_PWM_PRESCAL = 0x2                 /* Prescaler selected */
} timer_gdc_pwm_gdc_e;

/* GPWMCR.TCORE_EN - timer_gdc_pwm core control */
typedef enum tag_timer_gdc_pwm_tcore_e
{
    TIMER_GDC_PWM_CORE_DISABLE = 0x0,           /* Timer is disabled */
    TIMER_GDC_PWM_CORE_ENABLE  = 0x1            /* Timer is enabled */
} timer_gdc_pwm_tcore_e;
...
typedef struct tag_timer_gdc_pwm_Cfg_st
{
    timer_gdc_pwm_sclk_e  ePrescalClk;              /* Peripheral clock prescaler */
    timer_gdc_pwm_rc_e    eRst;                     /* Reset counter condition */
    timer_gdc_pwm_ved_e   eVSyncEd;                 /* VSync edge detection */
    timer_gdc_pwm_ved_e   eHsyncEd;                 /* HSync edge detection */
    timer_gdc_pwm_tcore_e eCoreEn;                  /* Enable the timer_gdc_pwm core [GDCPWM only] */
    timer_gdc_pwm_en_e    eIrqEn;                   /* Period end interrupt enable/disable */
    timer_gdc_pwm_en_e    eDblBuffEn;               /* Double-buffer on/off */
    timer_gdc_pwm_ol_e    eOutLevel;                /* Output level */
    timer_gdc_pwm_gdc_e   eClkSrc;                  /* Display synchronization signals */
} timer_gdc_pwm_Cfg_st;
...
/****************************************************************************
 *
 * Function:      vTIMER_GDC_PWM_GetVersion
 *
...
/****************************************************************************
 *
 * Function:      boTIMER_GDC_PWM_Config
 *
 * Purpose:       Configure a GDCPWM timer
 *
 ...
 *
 * Limitations:   Only GDC PWM timer channels may be provided
 *
 ***************************************************************************/
...
/****************************************************************************
 *
 * Function:      vTIMER_GDC_PWM_SetPeriod
 *
...
/****************************************************************************
 *
 * Function:      vTIMER_GDC_PWM_SetDuty
 *
...
/****************************************************************************
 *
 * Function:      u16TIMER_GDC_PWM_GetDuty
 *
...
/****************************************************************************
 *
 * Function:      i32TIMER_GDC_PWM_SetWaveform
 *
...
/****************************************************************************
 *
 * Function:      vTIMER_GDC_PWM_SetPrescaler
 *
...
/****************************************************************************
 *
 * Function:      vTIMER_GDC_PWM_SetRstCondition
 *
...
/****************************************************************************
 *
 * Function:      vTIMER_GDC_PWM_SetDetEdgeVsync
 *
...
/****************************************************************************
 *
 * Function:      vTIMER_GDC_PWM_SetDetEdgeHSync
 *
...
/****************************************************************************
 *
 * Function:      vTIMER_GDC_PWM_IrqEnable
 *
...
/****************************************************************************
 *
 * Function:      vTIMER_GDC_PWM_DBuffEnable
 *
...
/****************************************************************************
 *
 * Function:      i32TIMER_GDC_PWM_SetOutLevel
 *
...
/****************************************************************************
 *
 * Function:      vTIMER_GDC_PWM_SetClkSource
 *
...
/****************************************************************************
 *
 * Function:      vTIMER_GDC_PWM_GDCCoreEnable
 *
 * Purpose:       Enable/disables the GDC PWM timer core
 *
 * Inputs:        eCntrl   PWM timer controller
...
/****************************************************************************
 *
 * Function:      vTIMER_GDC_PWM_Enable
 *
...
/****************************************************************************
 *
 * Function:      u16TIMER_GDC_PWM_GetCountVal
 *
