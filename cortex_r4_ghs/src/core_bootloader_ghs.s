...
;******************************************************************************
;*   File Name   : $RCSfile: core_bootloader_ghs.s,v $
...
;*   DATE        : $Date: 2013-10-14 07:31:54 $
;*   SOURCE MOD. : $Source: /teenet/mpumcu/Capricorn/Capricorn_Bt/cortex_r4_ghs/src/core_bootloader_ghs.s,v $
...
; init DDR-interface
;******************************************************************************
    MOV   r0, #0                                 ; DMC_SDRAM_STATE_POWER_UP
    BL    u32DMC_Init
    NOP
    NOP
...
;/********************************* BEGIN OF LOG ******************************
;*
;* $Log: core_bootloader_ghs.s,v $
;* Revision 1.5  2013-10-14 07:31:54  mto
;* modify stack and TCMA & TCMB initialisation
;*
;* Revision 1.4  2013-10-07 07:49:58  mto
;* clear r0 to r2 (arguments) before jumping to main
;*
;* Revision 1.3  2013-07-24 13:50:23  mto
;* rename section excp_table_ram to exc_table
;*
;* Revision 1.2  2013-06-13 15:16:51  mto
;* add call to DMC-init function
;*
