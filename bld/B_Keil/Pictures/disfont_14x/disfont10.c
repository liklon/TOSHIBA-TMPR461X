 ...
 * Image Dimensions : Width=8, Height=9
 * Input Filename: C:\Users\liklon\Desktop\CM000\10\disfont10.png
 * Data is RLE compressed
 * Uncompressed Data Size : 0.28 KB
 * Compressed Data Size : 0.07 KB
 * Compression Ratio : 76.74%
 ************************************************************************/
...
#pragma alignvar(8)
#endif /* defined(__GHS__) || defined(__ghs__) */
ALIGNED const uint32_t u32_disfont10_RLE[DISFONT10_SIZE] = {
0xFFFFC09A, 0xFFFFC005, 0xFFFFFFDD, 0xFFF3FFFF, 0xFFFFC4FF, 0xFFFFC083, 0xFFFFC001, 0xFFFFFF82, 
0xFFFFFF02, 0x83FFFFD1, 0x05FFFFC0, 0xDDFFFFC0, 0xFFFFFFFF, 0xFFFFF3FF, 0x98FFFFC4, 0x01FFFFC0, 
0x00FFFFC0
};
